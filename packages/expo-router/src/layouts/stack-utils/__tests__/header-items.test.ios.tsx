...
it('should convert toolbar items children correctly to options', () => {
  ...
  const leftResult = appendStackToolbarLeftPropsToOptions(
    {},
    {
      children: [
  ...
  const rightResult = appendStackToolbarRightPropsToOptions(
    {},
    {
      children: [
        <StackToolbar.Menu
...
it('omits hidden Stack.Toolbar.Menu from header items', () => {
  const result = appendStackToolbarRightPropsToOptions(
    {},
    {
      children: [
...
it('Changes options dynamically when Stack.Toolbar.Left, Stack.Toolbar.Right and Stack.Header are used together', () => {
  function TestScreen() {
    return (
      <>
...
it('Changes options dynamically when Stack.Toolbar.Left is used is used in screen component', () => {
  function TestScreen() {
    return (
      <>
        <Stack.Toolbar.Left>
...
it('Changes options dynamically when Stack.Toolbar.Right is used in screen component', () => {
  function TestScreen() {
    return (
      <>
        <Stack.Toolbar.Right>
...
it('Changes options dynamically when Stack.Toolbar.Left and Stack.Toolbar.Right are used together', () => {
  function TestScreen() {
    return (
      <>
        <Stack.Toolbar.Left>
