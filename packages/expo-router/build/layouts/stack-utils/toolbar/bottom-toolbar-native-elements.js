...
const NativeToolbarMenu = ({ accessibilityHint, accessibilityLabel, separateBackground, hidesSharedBackground, palette, inline, hidden, subtitle, title, destructive, children, icon, image, tintColor, variant, style, elementSize, }) => {
    ...
    const validChildren = react_1.Children.toArray(children).filter((child) => (0, react_1.isValidElement)(child) &&
        (child.type === exports.NativeToolbarMenuAction ||
            child.type === exports.NativeToolbarMenu ||
            child.type === StackToolbarMenu_1.StackToolbarMenu ||
            child.type === StackToolbarMenu_1.StackToolbarMenuAction));
