...
declare const Stack: ((props: ComponentProps<typeof RNStack>) => React.JSX.Element) & {
    ...
    Toolbar: {
        Left: React.FC<import("./stack-utils").StackToolbarLeftProps>;
        Right: React.FC<import("./stack-utils").StackToolbarRightProps>;
        Bottom: React.FC<import("./stack-utils").StackToolbarBottomProps>;
