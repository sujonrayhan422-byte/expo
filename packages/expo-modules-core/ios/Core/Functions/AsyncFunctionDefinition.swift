...
public class AsyncFunctionDefinition<Args, FirstArgType, ReturnType>: AnyAsyncFunctionDefinition, @unchecked Sendable {
  ...
  @JavaScriptActor
  func call(_ appContext: AppContext, this: borrowing JavaScriptValue, arguments: borrowing JSValuesBuffer, callback: @Sendable @escaping (consuming FunctionCallResult) -> Void) {
  ...
  func build(appContext: AppContext) throws -> JavaScriptObject {
    ...
    return try appContext.runtime.createAsyncFunction(name) { [weak appContext, self] this, arguments in
      ...
      let result = try await withCheckedThrowingContinuation { continuation in
        self.call(appContext, this: this, arguments: arguments) { result in
